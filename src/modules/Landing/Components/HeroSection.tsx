const HeroSection = () => {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center pt-0 relative">
      <div className="relative z-10 text-center px-4 max-w-5xl">
        <h1 className="text-orange-600 text-4xl sm:text-6xl lg:text-7xl tracking-wide">
          Inclusión Sin Límites, Oportunidades Para Todos
        </h1>

        <p className="text-neutral-700 text-xl lg:text-center py-6">

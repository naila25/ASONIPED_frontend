  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8 overflow-x-hidden px-[max(0.75rem,env(safe-area-inset-left))] pr-[max(0.75rem,env(safe-area-inset-right))] pb-[max(0.75rem,env(safe-area-inset-bottom))]">
      <div className="max-w-7xl mx-auto min-w-0">
        ...
        <div className="mb-4 sm:mb-8">
          <div className="flex items-start sm:items-center gap-3 sm:gap-4 min-w-0">
            <button
              type="button"
              onClick={() => window.history.back()}
              className="flex-shrink-0 p-2 min-h-[44px] min-w-[44px] flex items-center justify-center text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors touch-manipulation"
              title="Volver"
              aria-label="Volver"
            >
        ...
        {/* Error Display */}
        {error && (
          <div className="mb-4 sm:mb-6 bg-red-50 border border-red-200 rounded-lg p-3 sm:p-4 min-w-0">
            <div className="flex gap-3">
              ...
              <div className="min-w-0">
                <h3 className="text-sm font-medium text-red-800">Error al crear expediente</h3>
